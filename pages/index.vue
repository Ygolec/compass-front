  ...
  <v-main
    ...
    <v-container>
      <v-row>
        <v-col>
          <v-card variant="flat"
          style="background-color: #031545">
            <v-card-title
                class="main-logo-text text-lg-h1"
            >
              HSE-Compass
            </v-card-title>
            <v-card-subtitle
                class="main-logo-text text-lg-h3"
            >
      ...
      <v-card variant="flat"
        ...
        <v-slide-group
            ...
            style="color: white"
        >
          <v-slide-group-item v-for="item in 12">
            <v-card
